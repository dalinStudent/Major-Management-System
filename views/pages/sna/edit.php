    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                ?>
                <form action="index1.php?action=edit_data&id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
                    <div class="card-body"  style="background-color: #C0C0C0;">
                            ...
                            <div class="form-group">
                                ...
                                <select name="major" id="major" class="form-control">
                                    <option <?php if($row['major'] == 'SNA'){?> selected="selected" <?php } ?>  value="SNA">SNA</option>
                                </select>
                            </div>
